...
export function TokenCardOption1({ token, onClick, rank }: TokenCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-video overflow-hidden">
        ...
        {rank <= 10 && (
          <motion.div
            className={`absolute top-3 right-3 flex items-center gap-1 px-2.5 py-1 rounded-lg bg-gradient-to-br ${getRankBadgeColor()} text-white font-bold text-sm shadow-lg`}
